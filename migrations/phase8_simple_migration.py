"""
Simple Phase 8 Analytics Database Migration (without foreign key constraints)
"""
...
def create_phase8_tables_simple():
    """Create Phase 8 analytics tables without foreign key constraints"""
    
    db_path = os.path.join(os.path.dirname(__file__), '..', 'mvtraders.db')
    
    # SQL statements for creating Phase 8 tables (without FK constraints)
    tables_sql = [
        """
...
if __name__ == "__main__":
    success = create_phase8_tables_simple()
    if success:
